...
## Mailing lists
- Use security-mailing-list@org.com to report security concerns to the Slingshot Security Team, who uses the list to privately discuss security issues and fixes prior to disclosure.
- Join security-vulnerability-disclosure@org.com for early private information and vulnerability disclosure. Early disclosure may include mitigating steps and additional information on security patch releases. See below for information on how Slingshot distributors or vendors can apply to join this list.
